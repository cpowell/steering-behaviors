...
class OrthogonalState < BasicGameState
  ID = 11 # Unique ID for this Slick game state
  ...
  def init(container, game)
    ...
    @hunter = Bug.new(MAX_X/2, MAX_Y/2, 135, 60, 1.1, 1.7854, 15, 150)
  ...
  def render(container, game, g)
    ...
    g.draw_string("Ortho to other's course (p to pause, r to randomize, ESC to exit)", 8, container.height - 30)
